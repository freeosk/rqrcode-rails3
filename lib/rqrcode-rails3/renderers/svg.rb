    ...
    class SVG
      class << self
        ...
        def render(qrcode, options={})
          ...
          open_tag  = %{<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events" viewBox="0 0 330 330">}
          close_tag = "</svg>"
